...
$webClient.DownloadFile('https://raw.githubusercontent.com/follesoe/Home/dev/dnvm.ps1', $dnvmPs1Path)
Write-Host "Downloading DNVM.cmd to $dnvmCmdPath"
$webClient.DownloadFile('https://raw.githubusercontent.com/follesoe/Home/dev/dnvm.cmd', $dnvmCmdPath)
